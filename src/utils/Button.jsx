...
const Button = ({action, link, title, isHide=false}) => {
  ...
  return (
    <div>
        <button className={`${classes} ${isHide ? 'hidden' : 'block'} rounded-[20px] px-4 py-2 hover:bg-green transition-all duration-300`}>

      ...
      {cartItems && cartItems.length > 0 ? (
        <>
          <ul className='flex items-center mb-3 w-full'>
            ...
            <li className='basis-[40%] grow-0 px-2'>Title</li>
            <li className='basis-[15%] grow-0 px-2 text-center'>Price</li>
            <li className='basis-[15%] grow-0 px-2 text-center'>Qty</li>
          ...
          <ul>
            {cartItems.map((item) => (
              <li key={item.id} className='flex items-center mb-3'>
                ...
                <h3 className='px-2 basis-[40%] grow h-full font-bold text-base sm:text-xl'>{item.title}</h3>
                <p className='basis-[15%] grow-0 text-center px-2'>{item.price}</p>
                <div className='basis-[15%] grow-0 flex items-center justify-center px-2'>
                  <button onClick={() => handleDecreaseQty(item)} className='mx-1'>
                    <span>-</span>
                  </button>
                  <p className='mx-2'>{item.qty}</p>
                  <button onClick={() => handleIncreaseQty(item)} className='mx-1'>
                    <span>+</span>
                  </button>
                </div>
